...
class Ui_main(object):
    def setupUi(self, main):
        ...
        self.spinBoxCurrFocal.setMaximumSize(QtCore.QSize(100, 16777215))
        ...
        self.groupBoxExposureFrameRate = QtWidgets.QGroupBox(main)
        self.groupBoxExposureFrameRate.setToolTip("")
        self.groupBoxExposureFrameRate.setObjectName("groupBoxExposureFrameRate")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.groupBoxExposureFrameRate)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.sliderExposure = QtWidgets.QSlider(self.groupBoxExposureFrameRate)
        ...
        self.gridLayout_6.addWidget(self.sliderExposure, 1, 0, 1, 5)
        self.label_14 = QtWidgets.QLabel(self.groupBoxExposureFrameRate)
        self.label_14.setObjectName("label_14")
        self.gridLayout_6.addWidget(self.label_14, 0, 0, 1, 1)
        self.label_15 = QtWidgets.QLabel(self.groupBoxExposureFrameRate)
        self.label_15.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_15.setObjectName("label_15")
        self.gridLayout_6.addWidget(self.label_15, 0, 2, 1, 1)
        self.spinBoxFrameRate = QtWidgets.QDoubleSpinBox(self.groupBoxExposureFrameRate)
        self.spinBoxFrameRate.setMinimumSize(QtCore.QSize(70, 0))
        self.spinBoxFrameRate.setMinimum(0.01)
        self.spinBoxFrameRate.setMaximum(999.99)
        self.spinBoxFrameRate.setSingleStep(0.05)
        self.spinBoxFrameRate.setProperty("value", 20.0)
        self.spinBoxFrameRate.setObjectName("spinBoxFrameRate")
        self.gridLayout_6.addWidget(self.spinBoxFrameRate, 0, 3, 1, 1)
        self.spinBoxExposure = QtWidgets.QSpinBox(self.groupBoxExposureFrameRate)
        self.spinBoxExposure.setMinimumSize(QtCore.QSize(55, 0))
        self.spinBoxExposure.setMaximumSize(QtCore.QSize(55, 16777215))
        ...
        self.gridLayout_6.addWidget(self.spinBoxExposure, 0, 1, 1, 1)
        self.checkBoxMaxFrameRate = QtWidgets.QCheckBox(self.groupBoxExposureFrameRate)
        self.checkBoxMaxFrameRate.setObjectName("checkBoxMaxFrameRate")
        self.gridLayout_6.addWidget(self.checkBoxMaxFrameRate, 0, 4, 1, 1)
        self.gridLayout_9.addWidget(self.groupBoxExposureFrameRate, 2, 0, 2, 1)
    ...
    def retranslateUi(self, main):
        ...
        self.groupBoxExposureFrameRate.setTitle(_translate("main", "Exposure and Framerate"))
        self.label_14.setText(_translate("main", "Exp:"))
        self.label_15.setText(_translate("main", "FPS:"))
        self.checkBoxMaxFrameRate.setText(_translate("main", "Max"))
